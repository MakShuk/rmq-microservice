...
const getConfiguration = (configService: ConfigService): RMQConfig => ({
  ...
  prefetchCount: configService.get('AMQP_PREFETCH_COUNT') ?? DEFAULT_CONFIG.PREFETCH_COUNT,
  serviceName: configService.get('AMQP_SERVICE_NAME') ?? DEFAULT_CONFIG.SERVICE_NAME,
});
